...
# source: net/device/DeviceServiceNb.proto
...
from net.device import PortStatisticsProto_pb2 as net_dot_device_dot_PortStatisticsProto__pb2
...
_GETDEVICESREPLY.fields_by_name['device'].message_type = net_dot_DeviceProto__pb2._DEVICEPROTO
_GETAVAILABLEDEVICESREPLY.fields_by_name['device'].message_type = net_dot_DeviceProto__pb2._DEVICEPROTO
_GETAVAILABLEDEVICESREQUEST.fields_by_name['type'].enum_type = net_dot_device_dot_DeviceEnumsProto__pb2._DEVICETYPEPROTO
_GETDEVICEREPLY.fields_by_name['device'].message_type = net_dot_DeviceProto__pb2._DEVICEPROTO
_GETROLEREPLY.fields_by_name['role'].enum_type = net_dot_device_dot_DeviceEnumsProto__pb2._MASTERSHIPROLEPROTO
_GETPORTSREPLY.fields_by_name['port'].message_type = net_dot_PortProto__pb2._PORTPROTO
_GETPORTSTATISTICSREPLY.fields_by_name['port_statistics'].message_type = net_dot_device_dot_PortStatisticsProto__pb2._PORTSTATISTICSPROTO
_GETPORTDELTASTATISTICSREPLY.fields_by_name['port_statistics'].message_type = net_dot_device_dot_PortStatisticsProto__pb2._PORTSTATISTICSPROTO
_GETSTATISTICSFORPORTREPLY.fields_by_name['port_statistics'].message_type = net_dot_device_dot_PortStatisticsProto__pb2._PORTSTATISTICSPROTO
_GETDELTASTATISTICSFORPORTREPLY.fields_by_name['port_statistics'].message_type = net_dot_device_dot_PortStatisticsProto__pb2._PORTSTATISTICSPROTO
_GETPORTREQUEST.fields_by_name['connect_point'].message_type = net_dot_ConnectPointProto__pb2._CONNECTPOINTPROTO
_GETPORTREPLY.fields_by_name['port'].message_type = net_dot_PortProto__pb2._PORTPROTO
...
getDeviceCountRequest = _reflection.GeneratedProtocolMessageType('getDeviceCountRequest', (_message.Message,), dict(
  ...
  __module__ = 'net.device.DeviceServiceNb_pb2'
